    ...
    >
      ...
      <div className="p-6 pt-5">
        ...
        <div className="space-y-4 text-sm">
          <div>
            <div
              className="text-[10px] text-[#592B41]/35 uppercase tracking-[0.15em] mb-1.5"
              style={{ fontFamily: BODY }}
            >
              Upbringing
            </div>
            <div className="text-[#2C1820]/70" style={{ fontFamily: BODY, fontWeight: 400 }}>
              {upbringing}
            </div>
          </div>
          ...
          <div>
            <div
              className="text-[10px] text-[#592B41]/35 uppercase tracking-[0.15em] mb-2"
              style={{ fontFamily: BODY }}
            >
              Strengths
            </div>
          ...
          <div>
            <div
              className="text-[10px] text-[#D4183D]/50 uppercase tracking-[0.15em] mb-2"
              style={{ fontFamily: BODY }}
            >
              Red Flags
            </div>
